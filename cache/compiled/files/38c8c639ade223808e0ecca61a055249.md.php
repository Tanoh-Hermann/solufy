...
return [
    ...
    'filename' => 'C:/laragon/www/angahi/user/pages/03.cpt363-intermediate/04.ux-techniques-guide/02.what-does-a-holistic-user-experience-design-process-look-like/scenario-based-design/topic.md',
    'modified' => 1583505712,
    'data' => [
        'header' => [
            'title' => 'Scenario-based Design (also known as Task-Centered Design)'
        ],
        'frontmatter' => 'title: \'Scenario-based Design (also known as Task-Centered Design)\'',
        'markdown' => 'Scenario-based Design (also known as Task-Centered Design)  
