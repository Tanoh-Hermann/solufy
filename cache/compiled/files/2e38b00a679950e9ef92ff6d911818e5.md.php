...
return [
    ...
    'filename' => 'C:/laragon/www/angahi/user/pages/03.cpt363-intermediate/04.ux-techniques-guide/10.how-to-plan-conduct-and-summarize-usability-tests/usability-testing-informal/topic.md',
    'modified' => 1583505712,
    'data' => [
        'header' => [
            'title' => 'Informal (Guerilla) Usability Testing'
        ],
        'frontmatter' => 'title: \'Informal (Guerilla) Usability Testing\'',
        'markdown' => 'Informal (Guerilla) Usability Testing  
