...
return [
    ...
    'timestamp' => 1591974622,
    'checksum' => 'd82e3bdb46f073f2d7e4bb0a868075be',
    'files' => [
        'user/config' => [
            'backups' => [
            ...
            'plugins/admin-addon-revisions' => [
                'file' => 'user/config/plugins/admin-addon-revisions.yaml',
                'modified' => 1590022306
            ],
            ...
            'plugins/admin-frontmatter-yaml' => [
                'file' => 'user/config/plugins/admin-frontmatter-yaml.yaml',
                'modified' => 1590022802
            ],
            'plugins/anchors' => [
            ...
            'plugins/atools' => [
                'file' => 'user/config/plugins/atools.yaml',
                'modified' => 1590619796
            ],
            'plugins/backtotop' => [
            ...
            'plugins/datetools' => [
                'file' => 'user/config/plugins/datetools.yaml',
                'modified' => 1590024652
            ],
            ...
            'plugins/editor-buttons' => [
                'file' => 'user/config/plugins/editor-buttons.yaml',
                'modified' => 1590024984
            ],
            'plugins/email' => [
            ...
            'plugins/github' => [
                'file' => 'user/config/plugins/github.yaml',
                'modified' => 1590025732
            ],
            'plugins/grava11y' => [
            ...
            'plugins/hax' => [
                'file' => 'user/config/plugins/hax.yaml',
                'modified' => 1590624138
            ],
            'plugins/httpbasicauth' => [
                'file' => 'user/config/plugins/httpbasicauth.yaml',
                'modified' => 1590026282
            ],
            'plugins/icalendar' => [
                'file' => 'user/config/plugins/icalendar.yaml',
                'modified' => 1590026466
            ],
            'plugins/iplocate' => [
                'file' => 'user/config/plugins/iplocate.yaml',
                'modified' => 1590026776
            ],
            'plugins/jscomments' => [
            ...
            'plugins/sequential-form' => [
                'file' => 'user/config/plugins/sequential-form.yaml',
                'modified' => 1590333866
            ],
            ...
            'plugins/webcomponents' => [
                'file' => 'user/config/plugins/webcomponents.yaml',
                'modified' => 1590619798
            ],
            'plugins/youtube' => [
        ...
        'user/plugins' => [
            ...
            'plugins/admin-addon-media-sort' => [
                'file' => 'user/plugins/admin-addon-media-sort/admin-addon-media-sort.yaml',
                'modified' => 1590022362
            ],
            'plugins/admin-addon-revisions' => [
                'file' => 'user/plugins/admin-addon-revisions/admin-addon-revisions.yaml',
                'modified' => 1590022112
            ],
            'plugins/admin-addon-user-manager' => [
            ...
            'plugins/admin-frontmatter-yaml' => [
                'file' => 'user/plugins/admin-frontmatter-yaml/admin-frontmatter-yaml.yaml',
                'modified' => 1590022802
            ],
            'plugins/archive_plus' => [
            ...
            'plugins/atools' => [
                'file' => 'user/plugins/atools/atools.yaml',
                'modified' => 1590619796
            ],
            'plugins/auto-date' => [
            ...
            'plugins/hax' => [
                'file' => 'user/plugins/hax/hax.yaml',
                'modified' => 1590619800
            ],
            'plugins/httpbasicauth' => [
                'file' => 'user/plugins/httpbasicauth/httpbasicauth.yaml',
                'modified' => 1590026282
            ],
            'plugins/icalendar' => [
            ...
            'plugins/iplocate' => [
                'file' => 'user/plugins/iplocate/iplocate.yaml',
                'modified' => 1590026776
            ],
            'plugins/jscomments' => [
            ...
            'plugins/sequential-form' => [
                'file' => 'user/plugins/sequential-form/sequential-form.yaml',
                'modified' => 1590069622
            ],
            'plugins/shortcode-core' => [
            ...
            'plugins/translator' => [
                'file' => 'user/plugins/translator/translator.yaml',
                'modified' => 1590097398
            ],
            'plugins/twigfeeds' => [
            ...
            'plugins/webpush' => [
                'file' => 'user/plugins/webpush/webpush.yaml',
                'modified' => 1590098518
            ],
            'plugins/widget' => [
                'file' => 'user/plugins/widget/widget.yaml',
                'modified' => 1590098806
            ],
            'plugins/youtube' => [
    ...
    'data' => [
        'plugins' => [
            ...
            'atools' => [
                'enabled' => true,
                'text_var' => 'Custom Text added by the **Atools** plugin (disable plugin to remove)'
            ],
            'auto-date' => [
                'enabled' => true
            ],
            ...
            'hax' => [
                'enabled' => false,
                'location' => 'https://cdn.webcomponents.psu.edu/cdn/',
                'location_other' => '',
                'pk' => '',
            ...
            'lightslider' => [
                ...
                'type_text_vertical_padding' => '250px',
            ...
            'webpush' => [
                ...
                'bell_unread' => '1',
                'bell_size' => 'small',
                'bell_position' => 'bottom-left',
                'bell_theme' => 'default',
                'bottom_offset' => '20px',
                'left_offset' => '20px',
                'right_offset' => '20px',
                'firsttime' => 'Click to subscribe to notifications',
                'unsubscribed' => 'Subscribe to notifications',
                'subscribed' => 'You\'re subscribed to notifications',
                'blocked' => 'You\'ve blocked notifications',
                'message_subscribed' => 'Thanks for subscribing!',
                'message_resubscribed' => 'You\'re subscribed to notifications',
                'message_unsubscribed' => 'You won\'t receive notifications again',
                'main_dialog' => 'Manage Site Notifications',
                'main_dialog_subscribe' => 'SUBSCRIBE',
                'main_dialog_unsubscribe' => 'UNSUBSCRIBE',
                'blocked_dialog_title' => 'Unblock Notifications',
                'blocked_dialog_message' => 'Follow these instructions to allow notifications',
                'action_message' => 'wants to show notifications',
                'auto_accept' => 'Click Allow',
                'sitename' => 'http://devlom.com',
                'example_desktop_title' => 'This is an example notification',
                'example_desktop_message' => 'Notifications will appear on your desktop',
                'example_mobile_title' => 'Example notification',
                'example_mobile_message' => 'Notifications will appear on your device',
                'example_caption' => '(you can unsubscribe anytime)',
                'accept' => 'CONTINUE',
                'cancel' => 'NO THANKS',
                'welcome_title' => 'Hello There',
                'welcome_message' => 'Thanks for subscribing!',
                'welcome_url' => 'http://devlom.com',
                'auto_prompt' => '1',
                'example_title' => 'This is an example notification',
                'example_message' => 'Notifications will appear on your desktop'
            ],
            'widget' => [
                'enabled' => true,
                'parent' => 'widgets',
...
node_modules'
        ...
        'groups' => [
            ...
            'Coaching subscribers' => [
                ...
                'readableName' => 'Coaching subscribers',
                'description' => 'Coaching subscribers',
                'enabled' => true
            ],
            'Project subscribers' => [
                'access' => [
                ...
                'readableName' => 'Project subscribers',
                'description' => 'Project subscribers',
                'enabled' => true
            ],
            'Côte d\'Ivoire' => [
                'access' => [
            ...
            'United States of America' => [
                ...
                'readableName' => 'United States of America',
